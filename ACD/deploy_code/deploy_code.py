...
def make_cmd(_section,_values):
    ...
    deploy_file_cmd="cd {0} && tar zxvf {1} && cd {2} && mv {3} {4} && cp -r {5} .".format(source_path,_section,dest_path,_section,bak_name,new_file)

    return deploy_file_cmd,start_cmd
...
def main():
    ...
    for section in sections:
        ...
        deploy_file_cmd,start_cmd=make_cmd(section,config_value)
        run_cmd(deploy_file_cmd,demo=True)
