...
def getcontentsys():
	...
	sql_select="select count(*) FROM goldq_user WHERE create_at  >='%s 00:00:00' AND create_at <='%s 23:59:59';"%(now_1_strf,now_1_strf)
	sql_1 = 'java -jar java-mysql-cmd.jar "mysql -hprod-goldpay.ccp7bt1yxa0k.ap-southeast-1.rds.amazonaws.com -uroot -paspectqa -Dprod-goldpay -e %s"'%sql_select
